...
# Adobe Commerce Optimizer Connector voor Commerce
...
>[!NOTE]
>
>Als u reeds een ontwikkelaarsproject hebt dat met de Ingestie API van Gegevens in de organisatie IMS wordt gevormd waar uw instantie van Commerce Optimizer wordt opgesteld, kunt u de vereiste API geloofsbrieven en organisatie identiteitskaart van OAUTH-server-aan-server geloofsbrieven in dat project krijgen.

Maak een nieuw ontwikkelaarsproject in de Adobe Developer-console voor Adobe Commerce Optimizer Ingestie API-referenties waarmee de integratie tussen Commerce- en Commerce Optimizer-instanties kan worden geconfigureerd. Voor instructies, zie [&#x200B; de Geloofsbrieven IMS &#x200B;](https://developer.adobe.com/commerce/services/optimizer/data-ingestion/authentication/#obtain-ims-credentials) in de *Handleiding van de Ontwikkelaar Merchandising* verkrijgen.
...
Adobe Commerce Optimizer-winkels configureren door catalogusweergaven en -beleid te maken. &#x200B; Zie [&#x200B; Creërend de Weergaven van de Catalogus &#x200B;](../optimizer/setup/catalog-view.md) in de Gids van Adobe Commerce Optimizer.
...
* `"commerce-core-endpoint": "Commerce cloud instance GraphQL endpoint"` , bijvoorbeeld `https://{{your store}}/graphql` .
...
* `"AC-Price-Book-ID": "base::b6589fc6ab0dc82cf12099d1c2d40ab994e8410c"` — Krijg deze waarde van de lijst van toegewezen prijsboeken in de [&#x200B; details van de catalogusmening &#x200B;](../optimizer/setup/catalog-view.md#view-details) in Adobe Commerce Optimizer.
