...
1. **configuratie van AEM Assets**: Vorm het de meta-gegevensprofiel van Commerce. Zie [&#x200B; een meta-gegevensprofiel &#x200B;](configure-aem.md#step-2-optional-configure-a-metadata-profile) vormen.
