...
## Inhoud van AEM Commerce-pakketten voor middelenhandel
...
1. Laat **Dynamische Media met mogelijkheden OpenAPI** toe.

   Als de **Dynamische Media met mogelijkheden OpenAPI** knoop niet actief is, open een steunkaartje.

>[!TAB  AEM Assets ]

[!BADGE &#x200B; slechts PaaS &#x200B;]{type=Informative tooltip="Alleen van toepassing op Adobe Commerce op Cloud-projecten (door Adobe beheerde PaaS-infrastructuur)."} op AEM as a Cloud Service, leg een de steunkaartje van Adobe met de volgende informatie voor:

* Titel: Dynamic Media OpenAPI inschakelen om Adobe Commerce volledig te integreren met AEM Assets

   * Inhoud van het ondersteuningsticket:
...
### Het tabblad Commerce is niet zichtbaar in eigenschappen
