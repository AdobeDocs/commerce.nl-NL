...
* Om [&#x200B; Dynamische Media met mogelijkheden OpenAPI &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dynamic-media-open-apis/dynamic-media-open-apis-overview#enable-dynamic-media-open-apis) op AEM as a Cloud Service toe te laten, leg een de steunkaartje van Adobe met de volgende informatie voor:

   * Titel: Dynamic Media OpenAPI inschakelen voor volledige integratie tussen Adobe Commerce en AEM Assets/Product Visuals aangedreven door AEM Assets
