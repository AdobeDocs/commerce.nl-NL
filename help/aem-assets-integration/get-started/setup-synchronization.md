...
1. [&#x200B; laat Adobe IMS voor Commerce &#x200B;](https://experienceleague.adobe.com/docs/commerce-admin/start/admin/ims/adobe-ims-config.html?lang=nl-NL){target=_blank} toe door de instructies in de *Gids van Admin van Commerce te volgen*.
