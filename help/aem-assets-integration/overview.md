...
Aan hefboomwerking deze integratie of met [&#x200B; Visuals van het Product of AEM Assets &#x200B;](https://experienceleague.adobe.com/en/docs/commerce/cloud-service/overview#product-visuals-powered-by-aem-assets), moeten de ondernemingen aan de volgende vereisten voldoen:
...
Bekijk deze video&#39;s om te leren hoe u de AEM Assets-integratie met Adobe Commerce instelt en gebruikt.
...
>[!TAB  ACCS Leerprogramma ]

Leer hoe u Adobe Commerce as a Cloud Service kunt gebruiken met de AEM Assets-integratie.
...
1. Configureer de integratie voor uw omgeving:

   * [!BADGE &#x200B; PaaS slechts &#x200B;]{type=Informative tooltip="Alleen van toepassing op Adobe Commerce op Cloud-projecten (door Adobe beheerde PaaS-infrastructuur)."} [&#x200B; Adobe Commerce (PaaS/ACCS) &#x200B;](get-started/setup-synchronization.md)
   * [!BADGE &#x200B; SaaS slechts &#x200B;]{type=Positive url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" tooltip="Alleen van toepassing op Adobe Commerce as a Cloud Service- en Adobe Commerce Optimizer-projecten (door Adobe beheerde SaaS-infrastructuur)."} [&#x200B; Adobe Commerce Optimizer &#x200B;](get-started/configure-aco.md)
