...
![ Nieuwe kwestie ](../assets/new.svg)<!-- Issue ACCS-169 --> de **[!UICONTROL Program ID]** en **[!UICONTROL Environment ID]** gebieden bevolken nu automatisch als dropdowns die op de zitting IMS van de gebruiker worden gebaseerd. Dit elimineert handingang en vermindert configuratiefouten. Om deze eigenschap te gebruiken, moet de gebruiker een rol in de [ AEM leveringslaag ](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/onboarding/journey/assign-profiles-aem#add-team-members){target=_blank} en een geldige [ Gevormde identiteitskaart van de Cliënt IMS van de Selecteur van Activa ](https://experienceleague.adobe.com/en/docs/commerce/aem-assets-integration/get-started/setup-synchronization#configure-the-connection){target=_blank} hebben.
