...
![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- Issue ACAP-1223 --> een kwestie waar de dubbele reeksen de rollen van het productbeeld in Admin voor configureerbare producten verschenen.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- Issue CCSAAS-4769 --> een kwestie in `UpdateAssetImageRolesDataPatch` die een schending van de integriteitsbeperking tijdens verbeteringen of gegevenspatches veroorzaakte.
