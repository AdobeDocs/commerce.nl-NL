...
| `eventData` | Object | De lading van de gebeurtenis verbonden aan het element (bijvoorbeeld, activa meta-gegevens uw matcher van `eventData.assetMetadata` leest). |
...
| `eventData` | Object | De lading van de gebeurtenis verbonden aan het product (bijvoorbeeld, gebieden uw matcher van de inkomende gebeurtenis gebruikt). |
