...
Wanneer al dit gegeven in het kader wordt opgenomen CCDM, is het resultaat een nieuwe verenigde basiscatalogus die in de de gegevenspijpleiding van de Dienst van de Catalogus beschikbaar is. In het volgende deel van het diagram ziet u meerdere kanalen. Elk kanaal vertegenwoordigt een bedrijfseenheid. Bijvoorbeeld, *de kleinhandel van Texas*, *de kleinhandel van Texas seizoensgebonden*, etc. Zoals u op het diagram kunt zien, kunnen de scènes, het beleid, en de prijsboeken allen over kanalen worden gedeeld. &#x200B;
...
![[!DNL Composable Catalog Data Model] Toewijzing kanaal, beleid en bereik ](assets/ccdm-scope-map.png)
...
| **Nieuwe het werkingsgebied van het catalogusproduct**: Het kanaal, het beleid, en het werkingsgebied zijn nieuw productwerkingsgebied dat door CCDM wordt geïntroduceerd. Dit productbereik vervangt het bereik van de website-, opslag- en opslagweergave in de laag met winkelservices. [ leer meer ](#product-context-management). | <ul><li>Met het nieuwe werkingsgebied, ontgrendelt CCDM de capaciteit om aan multi-geografie, multi-bedrijfs eenheid, multi-brand en meertalige gebruiksgevallen met gemak te schrapen gebruikend één enkele basiscatalogus.</li><li>Elimineer gegevensredundantie in uw catalogusbeheer.</li></ul> |
...
## Welk type van koopman profiteert het meest van CCDM?

De volgende lijst benadrukt gemeenschappelijke uitdagingen verkopers ontmoeten en hoe CCDM hen richt.
