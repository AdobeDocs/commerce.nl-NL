...
![&#x200B; Nieuw &#x200B;](../assets/new.svg) voegde een nieuwe `searchCategory` vraag van GraphQL toe die cliënten aan onderzoekscategorieën door naam met gepagineerde resultaten toelaat. De query accepteert een vereiste `searchTerm` (minimaal 3 tekens) en optionele `family` , `pageSize` en `currentPage` parameters. De resultaten zijn onder andere overeenkomende `CategoryTreeView` -objecten met metagegevens van volledige categorieën, a `totalCount` en `pageInfo` voor paginering. <!--COMOPT-1819-->

Deze query is alleen beschikbaar voor klanten die gebruikmaken van Adobe Commerce Optimizer Merchandising Services. Zie [&#x200B; searchCategory &#x200B;](https://developer.adobe.com/commerce/services/reference/graphql/).

### release v1.50

_7 April, 2026_

![&#x200B; Nieuw &#x200B;](../assets/new.svg) De `categoryTree](https://developer-stage.adobe.com/commerce/services/graphql-api/merchandising-api/index.html#query-categoryTree)` vraag heeft nu de parameter van de familiinput als facultatief. Dit staat voor een flexibelere categorieherwinning toe door toegang via slug zonder afhankelijkheid van een specifieke familieparameter toe te staan. Deze vraag is beschikbaar slechts voor [&#x200B; het Merchandising van Adobe Commerce Optimizer Services &#x200B;](https://developer.adobe.com/commerce/services/optimizer/merchandising-services/categories-storefront-implementation/).

### release v1.48

_19 februari, 2026_

![&#x200B; Nieuw &#x200B;](../assets/new.svg) de `categoryTree` vraag in GraphQL API keert nu categoriedomschrijvingen, beelden, en SEO meta- markeringen terug. Deze update biedt de gegevens die ontwikkelaars van winkeliers nodig hebben om categorieafbeeldingen weer te geven en de optimalisatie van zoekprogramma&#39;s te verbeteren met de juiste metatitels, beschrijvingen en trefwoorden. Slechts gesteund op de implementaties die van Commerce het [&#x200B; composable model van catalogusgegevens &#x200B;](https://developer.adobe.com/commerce/services/optimizer/) gebruiken voor headless storefronts&lt;<!--DATA-6933-->
...
## Installatieprogramma voor catalogusservice

Het installatieprogramma wordt geleverd met de extensie Catalog Service en verwerkt de installatie- en omgevingscontroles, zodat de Catalogusservice overeenkomt met uw Commerce-stapel.

- Voor **Adobe Commerce as a Cloud Service** klanten, is de recentste installerversie geïnstalleerd in uw milieu.

- Voor **Adobe Commerce op wolkeninfrastructuur** of **op gebouw**, houd het installatieprogramma gericht aan het [&#x200B; metapakket van de Dienst van de Catalogus &#x200B;](#catalog-service-metapackage): gebruik Composer om `magento/catalog-service-installer` te bevorderen wanneer u `magento/catalog-service` bevordert of wanneer deze versienota&#39;s een verandering beschrijven u, bijvoorbeeld, steun voor een nieuwe PHP versie nodig hebt. Op die manier blijft de installatietool compatibel met de versie van de Catalogusservice die u uitvoert.

### release v1.0.6

_Maart 25, 2026_

![&#x200B; Nieuw &#x200B;](../assets/new.svg) **PHP 8.5** - verzekert verenigbaarheid wanneer de Dienst van de Catalogus op PHP 8.5 werkt.
