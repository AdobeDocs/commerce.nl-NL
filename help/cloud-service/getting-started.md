...
1. **Beheerder van het Systeem**: [ voeg gebruikers toe en wijs rollen ](user-management.md#add-users) toe
...
>[!NOTE]
>
>Voordat u een instantie kunt maken, moet de productbeheerder van uw organisatie of de systeembeheerder u toevoegen als gebruiker van het [!DNL Adobe Commerce as a Cloud Service] -product. Zie [ gebruikers en beheerders ](./user-management.md#add-users) voor meer informatie toevoegen.
...
>[!NOTE]
>
>U kunt een bestaand exemplaar niet kopiëren of verwijderen.
