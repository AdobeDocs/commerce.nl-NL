...
De dienst van RAG maakt deel uit van de [&#x200B; de rekbaarheidshulpmiddelen van Commerce &#x200B;](https://developer.adobe.com/commerce/extensibility/developer-agent/){target="_blank"} MCP (ModelProtocol van de Context) server, die met Cursor en andere MCP-compatibele AI medewerkers integreert.
...
Het productieeindpunt wordt beschermd door [&#x200B; Voorste Door Azure &#x200B;](https://learn.microsoft.com/en-us/azure/frontdoor/front-door-overview), die de volgende bescherming omvat:
...
Door gebrek, gebruikt het documentatieonderzoek het voorste eindpunt van de Deur van de productie [&#x200B; Azure &#x200B;](https://learn.microsoft.com/en-us/azure/frontdoor/front-door-overview) met de bescherming van WAF. Voor test- of ontwikkelingsdoeleinden kunt u dit overschrijven met de omgevingsvariabele `FRONT_DOOR_URL` .
...
* [Adobe Commerce-documentatie voor ontwikkelaars](https://developer.adobe.com/commerce/docs/){target="_blank"}
* [App Builder-documentatie](https://developer.adobe.com/app-builder/docs/){target="_blank"}
* [Modelcontextprotocol](https://modelcontextprotocol.io/){target="_blank"}
* [CursorIDE](https://cursor.sh/docs){target="_blank"}
