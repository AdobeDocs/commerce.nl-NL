...
| [ Betalingen ](https://experienceleague.adobe.com/nl/docs/commerce-admin/stores-sales/payments/payments) | [ de Diensten van de Betaling voor Adobe Commerce ](../payment-services/guide-overview.md) | Beschikbaar | Een geïntegreerde betalingsdienst die veilige en efficiënte transacties vergemakkelijkt. |
