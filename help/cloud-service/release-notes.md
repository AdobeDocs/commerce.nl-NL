...
Als u [[!DNL Payment Services] ](https://experienceleague.adobe.com/en/docs/commerce/payment-services/get-started/production) toegelaten hebt, is [ Dashboard UI ](../payment-services/payments-home.md) nu beschikbaar in [!DNL Commerce Admin], die toegang tot het [ rapport van Transacties ](../payment-services/reporting.md#transactions-report-view) verleent voor het bekijken en het beheren van betalingstransacties. <!-- PAY-6510 -->
...
* Als een adres dat in het **]configuratiescherm van de Adressen van de E-mail van de Opslag[!UICONTROL ** wordt bepaald een waarde bevat die met `example.com` beëindigt, verzendt Commerce geen e-mails naar dit adres. In plaats daarvan logt het systeem aan dat de e-mail niet is verzonden.  <!-- CCSAAS-3533 -->
