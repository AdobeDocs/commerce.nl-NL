...
![ Nieuw ](../assets/new.svg) - toegevoegde steun voor een [ AEM storefront ](overview.md#supported-architecture).
...
![ Nieuwe ](../assets/new.svg) Toegevoegde PHP 8.5 steun.
...
Dit is een belangrijke versie. [ geeft ](install.md#update) het wortel composer.json- dossier van uw project uit.
...
![ Nieuw ](../assets/new.svg) - (Beta) Toegevoegde capaciteit om [ historische orde ](connect-data.md#send-historical-order-data) gegevens en status naar Experience Platform te verzenden.
