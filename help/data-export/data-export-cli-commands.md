...
>[!WARNING]
>
>Als u de opdracht resync gebruikt met de optie `cleanup-feed` , wordt de lokale exportstatus van de feed gewist en kan dit leiden tot onvolledige synchronisatie. Verwijderingen van entiteiten in Adobe Commerce worden bijvoorbeeld mogelijk niet weergegeven in verbonden Commerce Services, of verkoopeenheden blijven mogelijk in de externe Commerce Services-indexen, ook al zijn ze verwijderd of bijgewerkt in Adobe Commerce. Gebruik deze optie alleen voor volledige omgevingsrebuilds, zoals na het opschonen van een SaaS-gegevensruimte.
