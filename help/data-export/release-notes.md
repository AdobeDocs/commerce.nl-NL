...
![&#x200B; verbeter &#x200B;](../assets/fix.svg) **SQL Fouten wanneer het Schrappen van Statische Attributen EAV** - de stop ProductAttributeDelete produceert niet meer SQL fouten wanneer het schrappen van statische attributen EAV, die vlotter attributenbeheer en betere systeembetrouwbaarheid verzekeren. <!--MDEE-1336-->
![&#x200B; Repareren &#x200B;](../assets/fix.svg) **de Vaste uitvoer van de categoriepad na categoriemappen** - verzekert dat de categorievoer correct `url_path` bijwerkt wanneer een categorie aan een verschillende ouder wordt bewogen, verhinderend het missen of de schaalcategoriepaden in de verbonden diensten van Commerce.<!--MDEE-1331-->
![&#x200B; Repareren &#x200B;](../assets/fix.svg) **Verbeterde geplande categoriedoupdates voor verwante producten** - Gepland updates aan categorie URLs beïnvloedt nu slechts de voorgenomen categorieën, die gegevensintegriteit bewaren en onbedoelde veranderingen in verwante producten verhinderen. De geplande wijziging van de categorie-URL wordt nu correct weerspiegeld in geëxporteerde gegevens. Hierdoor blijven de storefront-navigatie en de gekoppelde services op één lijn met de huidige catalogus staan.
<!--MDEE-1321-->
