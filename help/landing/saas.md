...
Als u niet de eigenaar van de licentie bent, moet u de Commerce API-sleutels ophalen van de persoon of het team die de Commerce-licentie voor uw winkel heeft.

>[!NOTE]
>
>De API-sleutels kunnen alleen worden gegenereerd door de eigenaar van de licentie. Er is geen gedeelde toegangscapaciteit om andere gebruikers toe te staan om hen te produceren.
