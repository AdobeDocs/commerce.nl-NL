...
>[!NOTE]
>
>Sorteren op positie vereist dat een geldig `categoryPath` - of `categoryIds` -filter actief is. [&#x200B; leer meer &#x200B;](https://developer.adobe.com/commerce/webapi/graphql/schema/live-search/queries/product-search/#error-handling-for-categorypath-and-categoryids).
