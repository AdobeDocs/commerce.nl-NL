...
* Onboarding [&#x200B; synchronisatie van catalogusgegevens &#x200B;](install.md#sync)
...
Nadat de aanvankelijke index tijdens [&#x200B; onboarding &#x200B;](install.md#sync) wordt gebouwd, worden de volgende stijgende productupdates onophoudelijk gesynchroniseerd en opnieuw bepaald:
