...
source-git-commit: f2dc9d11fa36e54cb7c6366a64a1916c6afd2911
workflow-type: tm+mt
...
>[!IMPORTANT]
>
>Alvorens [!DNL Live Search] uit te voeren, zie de [&#x200B; Grenzen en 2&rbrace; sectie van Beperkingen &lbrace;om ervoor te zorgen dat [!DNL Live Search] uw bedrijfsbehoeften past.](boundaries-limits.md)

## Belangrijke updates

- Vanaf [!DNL Live Search] 3.0.2 wordt de extensie [!DNL Catalog Service] gebundeld met de installatie.

- Vanaf [!DNL Live Search] 4.0.0, is de onderzoeksadapter [&#x200B; afgekeurd &#x200B;](release-notes.md#live-search-400) geweest.
...
>
> Live zoeken is geen service die geschikt is voor HIPAA. Als u Adobe Commerce gebruikt met de HIPAA-Ready extensie en de invoegtoepassing Gezondheidszorg, moet u Live Search niet inschakelen in omgevingen waar mogelijk beschermde gezondheidsinformatie (PHI) wordt verwerkt.
>
> Voor details, zie [&#x200B; gereedheid van HIPAA op Adobe Commerce &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-admin/start/compliance/hipaa-ready-service/overview) en [&#x200B; Verrichtingen &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-admin/start/compliance/hipaa-ready-service/operations) begeleiding, die van Levend Onderzoek onder de niet-HIPAA klaar diensten van Commerce een lijst maakt.

## Workflowoverzicht

Op een hoog niveau is het vereist dat u: [!DNL Live Search]

1. [&#x200B; installeer &#x200B;](#install) de [!DNL Live Search] uitbreiding
1. [&#x200B; vorm &#x200B;](#configure) de API sleutels
1. [&#x200B; Synchroniseer &#x200B;](#sync) uw catalogusgegevens
1. [&#x200B; verifieer &#x200B;](#verify) dat de catalogusgegevens werden uitgevoerd
1. [&#x200B; vorm &#x200B;](#configuredata) de gegevens
1. [&#x200B; Test &#x200B;](#test) de verbinding
1. [&#x200B; bevestigt &#x200B;](#capture) dat de gebeurtenissen gegevens vangen
1. [&#x200B; pas &#x200B;](#customize) uw storefront aan

## &#x200B;1. De extensie [!DNL Live Search] installeren {#install}
...
1. Schakel [!DNL OpenSearch] en verwante modules uit en installeer [!DNL Live Search] . [!DNL OpenSearch] en [!DNL Live Search] kunnen niet beide op dezelfde Commerce-instantie worden ingeschakeld.
...
1. Schakel de extensie [!DNL Live Search] in en schakel [!DNL OpenSearch] uit (de modules Magento Elasticsearch en OpenSearch).
   ...
   >[!NOTE]
   >
   >[!DNL OpenSearch] en [!DNL Live Search] kunnen niet beide op dezelfde Commerce-instantie worden ingeschakeld. De opdracht Uitschakelen bevat een lijst met Commerce-modules die OpenSearch ondersteunen. Als er geen module is geïnstalleerd op uw Commerce-instantie, wordt een `module does not exist` -fout weergegeven.
...
## &#x200B;2. API-sleutels configureren {#configure}
...
## &#x200B;3. De catalogusgegevens synchroniseren {#sync}
...
Gebruik het [&#x200B; dashboard van het Beheer van Gegevens &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard) om synchronisatievooruitgang te controleren. Dit dashboard biedt waardevolle inzichten in de beschikbaarheid van productgegevens in uw winkel, zodat deze direct aan klanten kunnen worden weergegeven.
...
## &#x200B;4. Controleren of de gegevens zijn geëxporteerd {#verify}
...
## &#x200B;5. De gegevens configureren {#configuredata}
...
## &#x200B;7. Controleren of gebeurtenissen gegevens vastleggen {#capture}
...
## &#x200B;8. Aanpassen voor je winkel {#customize}
...
Automatische verzameling van gegevens over gebruikersinteractie werkt niet standaard als u de standaardcomponenten niet gebruikt, zoals Zoekadapter, Luminagewidgets of AEM CIF-widgets. Adobe AI gebruikt deze verzamelde gegevens voor intelligent winkelen en het volgen van prestaties. Om deze kwestie op te lossen, moet u een douaneoplossing ontwikkelen om deze gegevensinzameling op een krantenloze manier uit te voeren.
