...
1. Om een eenvoudige regel met één voorwaarde te bouwen, ga naar Stap 3: [ voegt gebeurtenissen ](#manual-ranking) toe.
...
1. Wanneer volledig, klik **sparen en publiceer**.
   ...
   >[!IMPORTANT]
   >
   >Als de knop **[!UICONTROL Save and publish]** grijs wordt weergegeven, controleert u of u alle vereiste informatie voor de regel hebt ingevoerd, inclusief de regelnaam.
