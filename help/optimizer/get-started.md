...
1. Instantie-instellingen configureren:
   - **Naam van de Instantie**: Beschrijvende naam (bijvoorbeeld &quot;Mijn bedrijf Sandbox&quot;)
   - **Beschrijving**: Korte beschrijving van het doel
   - **Type van Milieu**: Begin met a **zandbak** milieu voor het testen
   - **Gebied**: Selecteer uw voorkeursgebied
...
![&#x200B; Op rol-gebaseerde werkschema voor [!DNL Adobe Commerce Optimizer] opstelling die beheerder, ontwikkelaar, en gebruikerstaken tonen &#x200B;](./assets/high-level-workflow.png){zoomable="yes"}
...
| **creeer Instanties** | Sandbox- en productieomgevingen instellen | [&#x200B; creeer instantie &#x200B;](#step-1-create-an-instance) |
...
| **Ingest Gegevens van de Catalogus** | Productgegevens van bestaande systemen importeren | Om gegevens in Adobe Commerce Optimizer direct in te voeren, zie [&#x200B; Ingestie API van Gegevens &#x200B;](https://developer.adobe.com/commerce/services/optimizer/data-ingestion/){target="_blank"}.<br><br> om gegevens van Commerce op wolk of op gebouwmilieu&#39;s of andere derdesystemen in te voeren, zie het [&#x200B; 4&rbrace; onderwerp van Integraties &lbrace;.](./integrations/integrations-overview.md){target="_blank"} |
...
>[!NOTE]
>
>Niet alle [!DNL Adobe Commerce Optimizer] -gebruikers hebben toegang tot Cloud Manager. De toegang hangt van de rol en de toestemmingen af die aan de gebruikersrekening worden toegewezen.
...
1. Schakel tussen [!DNL Adobe Commerce Optimizer] -instanties zonder de toepassing te verlaten.
   ...
   ![&#x200B; de schakelaardropdown van de Instantie voor het selecteren van [!DNL Adobe Commerce Optimizer] milieu&#39;s &#x200B;](./assets/context-switcher.png){zoomable="yes"}

>[!NOTE]
>
>Als u aan de Manager van Commerce Cloud moet terugkeren om instantiedetails te bekijken, of instanties te beheren, klik het pictogram van Apps ![&#x200B; pictogram om de Toepassingen van Experience Cloud &#x200B;](./assets/apps-icon.png) in de hogere linkerhoek van de hoogste navigatie van Commerce Optimizer te openen.

### Instantiedetails ophalen

Bekijk de instantiedetails door op het informatiepictogram naast uw instantienaam te klikken.

![[!DNL Adobe Commerce Optimizer] Deelvenster met instantiedetails met eindpunten en instantie-id &#x200B;](./assets/aco-instance-details.png){width="60%" zoomable="yes"}
...
- **eindpunt van de Catalogus** voor het opnemen van catalogusgegevens in Commerce Optimizer die REST API gebruiken
- **Commerce Optimizer URL** om tot de [!DNL Adobe Commerce Optimizer] toepassing toegang te hebben
- **identiteitskaart van de Instantie**: de unieke id die de instantie identificeert. Instantieidentiteitskaart wordt ook bedoeld als *huurder_id*.
...
1. Volg de installatie-instructies in het README-bestand van de gegevensopslagruimte om de volgende taken uit te voeren:
   ...
   - Verifieer de gegevensopname door de gegevens van de Dienst van de Catalogus over de [&#128279;](./setup/data-sync.md) pagina van de Synchronisatie van 0&rbrace; Gegevens te controleren &lbrace;
...
- **Middelen van 0&rbrace; Storefront: [&#x200B; Commerce storefront documentatie &#x200B;](https://experienceleague.adobe.com/developer/commerce/storefront/?lang=nl-NL)**
- **Zelfstudies**: [&#x200B; zelfstudies van Commerce Optimizer &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-learn/tutorials/adobe-commerce-optimizer/overview)
