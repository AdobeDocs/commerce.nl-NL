...
| **Ingest Gegevens van de Catalogus** | Productgegevens van bestaande systemen importeren | Om gegevens in Adobe Commerce Optimizer direct in te voeren, zie [ Ingestie API van Gegevens ](https://developer.adobe.com/commerce/services/optimizer/data-ingestion/){target="_blank"}.<br><br> om gegevens van Commerce op wolk of op gebouwmilieu&#39;s of andere derdesystemen in te voeren, zie het [ 4} onderwerp van Integraties {.](./integrations/integrations-overview.md){target="_blank"} |
...
1. Volg de installatie-instructies in het README-bestand van de gegevensopslagruimte om de volgende taken uit te voeren:
   ...
   - Verifieer de gegevensopname door de gegevens van de Dienst van de Catalogus over de ](./setup/data-sync.md) pagina van de Synchronisatie van 0} Gegevens te controleren {[
...
- **Middelen van 0} Storefront: [ Commerce storefront documentatie ](https://experienceleague.adobe.com/developer/commerce/storefront/)**
