...
![&#x200B; Eenheid van Aanbeveling](../../assets/unit.png)
...
1. Op _[!DNL Adobe Commerce Optimizer]_&#x200B;sidebar, ga_ het Merchandising _>**Aanbevelingen**&#x200B;om de_ 6&rbrace; werkruimte van Aanbevelingen &lbrace;te tonen._

1. Op het **gebied van de mening van de Catalogus**, selecteer de catalogusmening waar u de aanbeveling beschikbaar wilt zijn. Leer meer over [&#x200B; gebruikend catalogusmeningen voor aanbevelingen &#x200B;](../../manage-results/recommendation-performance.md#select-catalog-view).

   >[!IMPORTANT]
   >
   >Deze eigenschap is momenteel in [&#x200B; bèta &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-operations/release/beta#merchandising-rules-globally-and-per-catalog-view-public-beta). Beta-deelnemers moeten eventuele bestaande aanbevelingen opnieuw maken om te kunnen profiteren van het nieuwe weergavebereik voor catalogi.

1. Klik **creëren aanbeveling**.

   De aanbeveling die u maakt, is beschikbaar in de eerder geselecteerde catalogusweergave.
...
1. Gebruik het _Aanbevolen paneel van de productvoorproef_ beter om te begrijpen hoe de filters beïnvloeden welke producten in de aanbeveling eenheid worden getoond. Leer meer over hoe te [&#x200B; voorproefaanbevelingen &#x200B;](#preview-recommendations).
...
>[!NOTE]
>
>U kunt maximaal 50 actieve aanbevelingen maken. Zie [&#x200B; grenzen en grenzen &#x200B;](../../boundaries-limits.md) voor details.
...
Voor multi-storefront, multi-taal, of multi-brand montages, kunt u vormen of elke aanbeveling op alle catalogusmeningen (globaal) of op één enkele [&#x200B; catalogusmening &#x200B;](../../setup/catalog-view.md) van toepassing is. Leer meer over hoe te om [&#x200B; de catalogusmening &#x200B;](../../manage-results/recommendation-performance.md#select-catalog-view) te plaatsen wanneer het werken met aanbevelingen.
...
1. Op _[!DNL Adobe Commerce Optimizer]_&#x200B;sidebar, ga_ Merchandising _>**Aanbevelingen**.
...
1. In het menu, kunt u **deactiveren** Schrapping **, of** uitgeven **de aanbeveling.** Als u **uitgezocht geef** uit, kunt u de volgende montages aanpassen zoals nodig:
   ...
   U kunt het type aanbeveling of de catalogusweergave niet wijzigen. De catalogusweergave wordt ingesteld wanneer u de aanbeveling maakt. Meer leren, zie [&#x200B; uitgezochte catalogusmening &#x200B;](../../manage-results/recommendation-performance.md#select-catalog-view).

1. Wanneer volledig, klik **sparen Veranderingen**.

## Gereedheidsindicatoren

Gereedheidsindicatoren laten zien welke aanbevolen typen het beste presteren op basis van de beschikbare catalogus- en gedragsgegevens. Zij kunnen u ook helpen potentiële kwesties met [&#x200B; gebeurtenisinzameling &#x200B;](../../setup/events/overview.md) identificeren of bepalen of een aanbevelingstype niet genoeg verkeer ontvangt om resultaten te produceren.
...
Als gevolg van deze variabelen kan het percentage van de gereedheidsindicator fluctueren. Deze schommeling verklaart waarom u zou kunnen zien dat de aanbevelingen types binnen en uit zijn &quot;bereid zijn op te stellen&quot;komen.

Gereedheidsindicatoren worden berekend op basis van een aantal factoren:

- Voldoende resultaat vastgestelde grootte: Zijn er genoeg resultaten die in de meeste scenario&#39;s worden teruggekeerd om te vermijden gebruikend [&#x200B; reserveaanbevelingen &#x200B;](../../setup/events/overview.md#backup-recommendations)?
...
- 75% of hoger betekent dat de aanbevelingen voor dat soort aanbevelingen zeer relevant zijn.
- Ten minste 50% betekent dat de aanbevelingen die voor dat soort aanbevelingen worden voorgesteld minder relevant zijn.
- Minder dan 50% betekent dat de aanbevelingen voor dat soort aanbevelingen wellicht niet relevant zijn. In dit geval, [&#x200B; reserveaanbevelingen &#x200B;](../../setup/events/overview.md#backup-recommendations) worden gebruikt.

Leer meer over [&#x200B; waarom de gereedheidsindicatoren laag &#x200B;](#what-to-do-if-the-readiness-indicator-is-low) zouden kunnen zijn.
...
De gereedheidsindicator voor aanbevolen typen die afhankelijk zijn van catalogusgegevens verandert niet veel omdat de catalogus van de handelaar zelden verandert. Maar de gereedheidsindicator voor aanbevolen typen die zijn gebaseerd op gedragsgegevens van winkels kan vaak veranderen, afhankelijk van de dagelijkse verkoopactiviteit.

#### Wat moet u doen als de gereedheidsindicator laag is

Een laag gereedheidspercentage geeft aan dat er niet veel producten uit uw catalogus zijn die in aanmerking komen om te worden opgenomen in de aanbevelingen voor dit soort aanbevelingen. Dit betekent dat er een hoge waarschijnlijkheid is dat [&#x200B; reserveaanbevelingen &#x200B;](../../setup/events/overview.md#backup-recommendations) zijn teruggekeerd als u dit aanbevelingstype hoe dan ook opstelt.
...
- **op dynamisch-Gebaseerd** - de Lage percentages voor op dynamisch-gebaseerde indicatoren kunnen door worden veroorzaakt:
   ...
   - Laag verkeer aan de opslag zodat is het volume van ontvangen gedragsgebeurtenissen laag.
