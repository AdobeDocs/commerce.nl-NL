...
- **Admin** - er zijn drie verschillende soorten admin rollen:
   ...
   - [&#x200B; Admins van het Product &#x200B;](#add-a-product-admin) - de beheerders van het Product kunnen [&#x200B; gebruikers, rollen, en toestemmingen voor het product &#x200B;](#add-users) in [!DNL Adobe Admin Console] beheren.
   - [&#x200B; het profielbeheerders van het Product &#x200B;](#add-developers-and-product-profile-admins) - de profielbeheerders van het Product kunnen gebruikers voor het product in [!DNL Adobe Admin Console] beheren.
...
Er zijn twee verschillende manieren om gebruikers van productbeheer aan [!DNL Adobe Commerce Optimizer] toe te voegen gebaseerd op wanneer uw organisatie provisioned was. In vroege toegangsorganisaties, heeft elke gebruiker die de product admin rol wordt toegewezen toestemming om alle instanties in de organisatie te beheren. In organisaties voor algemene beschikbaarheid (GA) die na 13 oktober 2025 zijn ingericht, kunt u een gebruiker toewijzen als productbeheerder voor specifieke instanties. Wanneer de gebruiker van de productbeheerder zich aanmeldt, kunnen deze alleen de instanties zien die hij of zij mag beheren.
...
>[!NOTE]
>
>Alleen productbeheerders en systeembeheerders kunnen gebruikers en ontwikkelaars toevoegen aan het [!DNL Adobe Commerce Optimizer] -product.
