...
| [!UICONTROL App Switch] | winkelweergave | Deze optie is op **slechts 1&rbrace; verkopers en kopers van de V.S. van toepassing.** Wanneer deze optie is ingeschakeld, proberen alle Express PayPal-betalingen de mobiele PayPal-app te gebruiken, zodra deze beschikbaar is. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Contact Preference] | winkelweergave | Deze optie is op **slechts 1&rbrace; verkopers en kopers van de V.S. van toepassing.** Als geplaatst aan **ja**, zullen de kopers e-mail en het telefoonaantal in de Betalingsmodule PayPal tonen. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
...
1. Vouw in het linkerdeelvenster **[!UICONTROL Sales]** uit en kies **[!UICONTROL Payment Methods]** .
1. Vouw de sectie _[!UICONTROL FEATURED ADOBE PAYMENT SOLUTION]_&#x200B;uit.
1. Vouw in de sectie _[!UICONTROL Payment Services]_&#x200B;de sectie&#x200B;_[!UICONTROL Local Payment Methods]_ uit.
