...
Zie [ de opties van Betalingen ](payments-options.md#paypal-payment-buttons) voor meer informatie.
...
1. Vouw in het linkerdeelvenster **[!UICONTROL Sales]** uit en kies **[!UICONTROL Payment Methods]** .
1. Vouw de sectie _[!UICONTROL FEATURED ADOBE PAYMENT SOLUTION]_uit.
1. Vouw in de sectie _[!UICONTROL Payment Services]_de sectie_[!UICONTROL Fastlane]_ uit.
...
1. Navigeer in de sectie _[!UICONTROL Payment Services]_naar de sectie_[!UICONTROL Fastlane]_ .
1. Vouw de sectie _[!UICONTROL Advanced Style Settings (optional)]_uit.
...
>[!IMPORTANT]
>
> Apple wijst betalingen van niet-geverifieerde domeinen af. Handelaars moeten alle domeinen verifiëren waar Apple Pay-knoppen worden gebruikt. Landbeperkingen zijn van toepassing. Zie de [ documentatie van Apple betalen ](https://developer.apple.com/documentation/apple_pay_on_the_web) voor meer informatie over de vereisten van de domeincontrole.
...
| [!UICONTROL Title] | winkelweergave | Voeg de tekst die tijdens het afrekenen als titel voor deze betalingsoptie moet worden weergegeven, toe in de weergave Betalingsmethode. Opties: [!UICONTROL text field] |
| [!UICONTROL Payment Action] | website | De [ betalingsactie ](https://experienceleague.adobe.com/docs/commerce-admin/config/sales/payment-methods/payment-methods.html) voor de gespecificeerde betalingsmethode. Opties: [!UICONTROL Authorize] / [!UICONTROL Authorize and Capture] |
| [!UICONTROL Show Apple Pay on checkout page] | website | Schakel [!DNL Apple Pay] in of uit op de uitcheckpagina. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Show Apple Pay at start of checkout] | winkelweergave | Schakel [!DNL Apple Pay] in of uit aan het begin van de afrekenstroom. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Sort order] | winkelweergave | De sorteervolgorde voor de opgegeven betalingsmethode op de uitcheckpagina. `Numeric Only` value |
| [!UICONTROL Show Apple Pay on product detail page] | winkelweergave | Schakel [!DNL Apple Pay] in of uit op de pagina met productdetails. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Show Apple Pay in mini cart preview] | winkelweergave | Schakel [!DNL Apple Pay] in of uit in de voorvertoning van de miniwinkelwagentje. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Show Apple Pay on cart page] | winkelweergave | Schakel [!DNL Apple Pay] in of uit op de tekstpagina. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Debug Mode] | website | De foutopsporingsmodus in- of uitschakelen. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
...
| [!UICONTROL Payment Action] | website | De [ betalingsactie ](https://experienceleague.adobe.com/docs/commerce-admin/config/sales/payment-methods/payment-methods.html) voor de gespecificeerde betalingsmethode. Opties: `[!UICONTROL Authorize]` / `[!UICONTROL Authorize and Capture]` |
| [!UICONTROL Show Google Pay on checkout page] | website | Schakel [!DNL Google Pay] in of uit op de uitcheckpagina. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Show Google Pay at start of checkout] | winkelweergave | Schakel [!DNL Google Pay] in of uit aan het begin van de afrekenstroom. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Sort order] | winkelweergave | De sorteervolgorde voor de opgegeven betalingsmethode op de uitcheckpagina. `Numeric Only` value |
| [!UICONTROL Show Google Pay on product detail page] | winkelweergave | Schakel [!DNL Google Pay] in of uit op de pagina met productdetails. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Show Google Pay in mini cart preview] | winkelweergave | Schakel [!DNL Google Pay] in of uit in de voorvertoning van de miniwinkelwagentje. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Show Google Pay on cart page] | winkelweergave | Schakel [!DNL Google Pay] in of uit op de tekstpagina. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
...
Zie [ documentatie van het de verzoekvoorwerp van Google van de Betaling API van 0} {voor meer informatie.](https://developers.google.com/pay/api/web/reference/request-objects)
...
| [!UICONTROL Display Pay Later Message] | website | Schakel de PayPal Pay Later-berichten in of uit in het winkelwagentje, de productpagina, de miniwinkelwagentje en tijdens de afrekenstroom. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
...
| [!UICONTROL Show buttons at start of checkout] | winkelweergave | Schakel [!DNL PayPal payment buttons] in of uit aan het begin van de afrekenstroom. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Sort order] | winkelweergave | De sorteervolgorde voor de opgegeven betalingsmethode op de uitcheckpagina. `Numeric Only` value |
...
| [!UICONTROL App Switch] | winkelweergave | Deze optie is op **slechts 1} verkopers en kopers van de V.S. van toepassing.** Wanneer deze optie is ingeschakeld, proberen alle Express PayPal-betalingen de mobiele PayPal-app te gebruiken, zodra deze beschikbaar is. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Contact Preference] | winkelweergave | Deze optie is op **slechts 1} verkopers en kopers van de V.S. van toepassing.** Als geplaatst aan **ja**, zullen de kopers e-mail en het telefoonaantal in de Betalingsmodule PayPal tonen. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
...
Lokale betalingsmethoden (LPM&#39;s) bieden ondersteuning voor regiospecifieke en lokale betalingsmethoden, zoals bankoverschrijvingen en gelokaliseerde betalingsoplossingen, naast bestaande op kaarten gebaseerde opties. Handelaars kunnen beschikbare LPMs direct binnen de configuratie van Commerce toelaten of onbruikbaar maken. Zie [ de opties van de Betaling ](payments-options.md#local-payment-methods) voor meer informatie over beschikbare methodes.

1. Voor _Admin_ sidebar, ga **[!UICONTROL Stores]** > _[!UICONTROL Settings]_>**[!UICONTROL Configuration]**.
1. Vouw in het linkerdeelvenster **[!UICONTROL Sales]** uit en kies **[!UICONTROL Payment Methods]** .
1. Vouw de sectie _[!UICONTROL FEATURED ADOBE PAYMENT SOLUTION]_uit.
1. Vouw in de sectie _[!UICONTROL Payment Services]_de sectie_[!UICONTROL Local Payment Methods]_ uit.
1. Selecteer voor **[!UICONTROL Active]** `Yes` om LPM&#39;s in te schakelen of `No` om ze uit te schakelen.
1. Voer bij **[!UICONTROL Title]** de tekst in die tijdens het uitchecken als naam van de betalingsmethode moet worden weergegeven. Deze titel wordt ook weergegeven in het raster van de verkooporder.
1. Selecteer voor **[!UICONTROL Allowed Payment Methods]** de betalingsmethoden die u wilt aanbieden. Welke methoden beschikbaar zijn, is afhankelijk van het factuuradres van de koper en de basisvaluta van de website.
1. Voer bij **[!UICONTROL Sort Order]** een numerieke waarde in om de weergavepositie van LPM&#39;s in de lijst met beschikbare betalingsmethoden te bepalen.
1. Klik op **[!UICONTROL Save Config]** om de wijzigingen op te slaan.
1. Navigeer naar **[!UICONTROL System]** > **[!UICONTROL Cache Management]** en klik vervolgens op **[!UICONTROL Flush Cache]** om alle ongeldige cache te vernieuwen.
...
| Veld | Bereik | Beschrijving |
|---|---|---|
| [!UICONTROL Active] | website | Lokale betalingsmethoden in- of uitschakelen. Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
| [!UICONTROL Title] | winkelweergave | De naam van de betalingsmethode die wordt weergegeven tijdens het uitchecken en in het raster van de verkooporder. Opties: [!UICONTROL text field] |
| [!UICONTROL Allowed Payment Methods] | website | Selecteer welke LPMs aan te bieden. Methoden zijn alleen zichtbaar voor klanten wier factureringsadres en websitevaluta overeenkomen met de vereisten van de methode. Opties: `Bancontact` / `BLIK` / `eps` / `iDEAL` / `MyBank` / `Przelewy24` |
| [!UICONTROL Sort Order] | winkelweergave | De weergavepositie van de LPM-groep in de lijst met beschikbare betalingsmethoden. Deze instelling is van toepassing op alle LPM&#39;s als een groep; afzonderlijke LPM&#39;s kunnen niet afzonderlijk worden gesorteerd. `Numeric Only` value |

>[!NOTE]
>
>Elke lokale betalingsmethode (LPM) heeft specifieke land - en valutavereisten. Een betalingsmethode wordt alleen weergegeven wanneer het land van het factuuradres van de klant en de basisvaluta van de website aan deze vereisten voldoen. Bancontact wordt bijvoorbeeld alleen weergegeven voor klanten met een Belgisch factuuradres wanneer de basisvaluta EUR is.

## Regelitems

Regelobjecten sturen gedetailleerde bestelgegevens naar PayPal, waaronder productgegevens, hoeveelheden en prijzen. Deze functie is standaard ingeschakeld. Zie [ Punten van de Lijn ](line-items.md) voor meer informatie.

### Configuratieopties

| Veld | Bereik | Beschrijving |
|---|---|---|
| [!UICONTROL Line Items Enabled] | website | In- of uitschakelen van regelitems en het afbreken van het bedrag naar PayPal. Schakel deze instelling uit als u extensies van derden gebruikt die aangepaste kosten toevoegen die niet worden ondersteund door [!DNL Payment Services] . Opties: `[!UICONTROL Yes]` / `[!UICONTROL No]` |
...
* **betaal met[!DNL Payment Services]** - Deze middel zorgt ervoor dat wanneer u een orde in Admin creeert, [!DNL Payment Services] creditcards beschikbaar als betalingsmethode zijn. Als u het **1} oudermiddel van Acties {selecteert, zal dit middel ook worden geselecteerd.**
