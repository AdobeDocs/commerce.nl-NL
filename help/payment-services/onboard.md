...
description: Verbind uw instantie met  [!DNL Payment Services]  door onboarding voor uw plaatsing van Adobe Commerce, met zandbak en productiestappen voor PaaS, op-gebouw, en SaaS te voltooien.
role: User
level: Intermediate
...
1. [ opstelling de zandbakdienst ](sandbox.md#enable-sandbox-testing)
