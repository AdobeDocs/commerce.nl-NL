...
* **[- Grafiek beschikbaar op het Huis van de Diensten van de Betaling dat een visuele vertegenwoordiging van samengevoegde bedragen per dag van de het rapportmening van Uitbetalingen is](#payouts-data-visualization-view)**
...
1. Klik het _pictogram van de Download_ ( ![&#x200B; pictogram van de Download &#x200B;](assets/icon-download.png){width="20" zoomable="yes"}).
