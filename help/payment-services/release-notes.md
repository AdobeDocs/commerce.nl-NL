...
Deze releaseopmerkingen beschrijven alle releases van [!DNL Payment Services] en bevatten:
...
![&#x200B; Nieuwe kwestie &#x200B;](../assets/new.svg)<!-- Issue PAY-6374 --> nu, richt de **knoop van Montages** op het [!DNL Payment Services] dashboard zich aan de Admin configuratiepagina voor betalingsmethodes, die een meer gestroomlijnde werkschema verstrekken voor het beheren van betalingsmontages.

_Januari 19, 2026_

![&#x200B; Nieuwe kwestie &#x200B;](../assets/new.svg)<!-- Issue PAY-6325 --> nu, kunnen de handelaren PayPal Seller identiteitskaart als kolom in het [&#x200B; transactierapport &#x200B;](reporting.md#transactions-report-view) bekijken helpen transacties identificeren die een bepaalde klant heeft geplaatst.
...
![&#x200B; Nieuwe kwestie &#x200B;](../assets/new.svg)<!-- Issue PAY-5658 --> nu, kunnen de handelaren transacties door het Detail van de Betaling in het [&#x200B; transactierapport &#x200B;](reporting.md#transactions-report-view) voor meer gedetailleerde en nauwkeurige gegevens van betalingsmethodes filtreren.

_15 juli 2024_

![&#x200B; Nieuwe kwestie &#x200B;](../assets/new.svg)<!-- Issue PAY-5571 --> nu, kunnen de handelaren transacties door de klant-e-mail van Commerce in het [&#x200B; transactierapport &#x200B;](reporting.md#transactions-report-view) filtreren. Voer de e-mail van de klant in om transacties voor die specifieke e-mail te filteren.

_9 Juli, 2024_

![&#x200B; Nieuwe kwestie &#x200B;](../assets/new.svg)<!-- Issue PAY-5488 --> nu, kunnen de handelaren Commerce klantenidentiteitskaart als kolom in het [&#x200B; transactierapport &#x200B;](reporting.md#transactions-report-view) bekijken helpen transacties identificeren die een bepaalde klant heeft geplaatst. Bovendien kunnen verkopers het transactierapport door deze klant-id van Commerce voor bijbehorende orders filteren.
...
![&#x200B; Nieuwe kwestie &#x200B;](../assets/fix.svg)<!-- Issue PAY-4888 --> nu, kunnen de handelaren krediet en debetkaarttransacties door de laatste vier cijfers van het kaartaantal in het [&#x200B; rapport van Transacties &#x200B;](reporting.md#transactions-report-view) filtreren.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-4288 --> nu, kunnen de handelaren [&#x200B; _slechts_ PayPal betaalknopen &#x200B;](payments-options.md#use-only-paypal-payment-buttons) vormen - en _gebruiken_ niet de optie van de creditcardbetaling van PayPal. Op deze manier kunnen verkopers verschillende betalingsopties aanbieden, zoals de betalingsknoppen Venmo en PayPal, en een bestaande creditcardprovider gebruiken in plaats van de optie PayPal-creditcardbetaling.

![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-4050 --> Toegevoegde a [&#x200B; mening van de gegevensvisualisatie &#x200B;](payouts.md#payouts-data-visualization-view), die op het Huis van de Dienst van de Betaling, voor het rapport van de de betalingsstatus van de Orde verschijnt.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-3705 --> `increment_id` is nu beschikbaar voor gebruik in het in overeenstemming brengen van uitbetalingen in externe systemen ERP. Het wordt verspreid aan `custom_id` _en_ `invoice_id`, zichtbaar in zowel de PayPal webhaak als het bedrijfsactiviteitendetail voor een uitbetaling.
...
![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- Issue PAY-3420 --> Pay van Apple is nu beschikbaar als Slimme Knoop van PayPal. Deze [&#x200B; betalingsoptie &#x200B;](payments-options.md#apple-pay-button) laat klanten toe om de eigenschap van identiteitskaart van de Aanraking op hun iOS of apparaat van macOS te gebruiken om Apple te selecteren betaalt. Apple Pay verwerkt de betaling met de betalingsgegevens van de creditcard en de bankpas die op het apparaat zijn opgeslagen.

_Juni 28, 2021_

![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- Issue PAY-1720 --> Geschillen voor opslagorden zijn nu beschikbaar in [&#x200B; het rapport van de de betalingsstatus van de Orde &#x200B;](order-payment-status.md#view-disputes). U kunt geschillen oplossen door rechtstreeks vanuit [!DNL Payment Services] naar het PayPal Resolution Center te navigeren.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-2761 --> U kunt de gegevens nu aanpassen die in het [&#x200B; rapport van de de betalingsstatus van de Orde &#x200B;](order-payment-status.md#show-and-hide-columns) en het [&#x200B; rapport van Uitbetalingen &#x200B;](payouts.md#show-and-hide-columns) door kolommen te tonen of te verbergen gebruikend de de montagecontrole van de Kolom tonen.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- PAY-6400 --> voegde a **[!UICONTROL Line Items Enabled]** configuratie toe om het verzenden van lijnpunten en waardeverdeling aan PayPal toe of onbruikbaar te maken. Met deze instelling kunt u problemen met het afrekenen oplossen wanneer externe extensies aangepaste kosten toevoegen die niet worden ondersteund door [!DNL Payment Services] . Zie [&#x200B; Punten van de Lijn &#x200B;](line-items.md) voor meer informatie.

![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- PAY-6457 --> Toegevoegde [&#x200B; Uitdrukkelijke betalingsknopen bij het begin van controle &#x200B;](payments-options.md#express-checkout-buttons) om snellere controles aan te moedigen.

![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- PAY-6458 --> Toegevoegde steun voor [&#x200B; Lokale Wijzen van de Betaling (LPMs) &#x200B;](payments-options.md#local-payment-methods) voor gebied-specifieke en lokale betalingsopties. De handelaren kunnen beschikbare LPMs direct binnen [&#x200B; Commerce &#x200B;](configure-admin.md#local-payment-methods) toelaten of onbruikbaar maken.

![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- PAY-6377 --> Toegevoegde het land van de a [&#x200B; Koper &#x200B;](sandbox.md#buyers-country) zandbakconfiguratie om de plaats en de controle van de koper te simuleren die betalingsmethodes worden teruggegeven.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6458 --> Verbeterde verenigbaarheid met de fraudefilters van PayPal door koper e-mailadresgegevens over te gaan, verbeterend mogelijkheden van de fraudebescherming.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6413 --> een kwestie opgelost waar de PayPal-kassa niet voor virtuele producten wegens een ontbrekend verzendadres kon worden voltooid.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6450 --> een kwestie waar de PayPal knoop controlefouten niet correct op de pagina&#39;s van het productdetail, minicart, karretje, en bovenkant van controle werden behandeld.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6453 --> Uitgeschakelde server-kant verschepen callbacks stromen op de controle van GraphQL om conflicten op controle te verhinderen.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6456 --> werkte de [&#x200B; Apple 3&rbrace; configuratiebeschrijving van het Betalen &lbrace;bij om te verduidelijken dat Apple betalingen van ongeverifieerde domeinen verwerpt. &#x200B;](configure-admin.md#apple-pay) Handelaars moeten alle domeinen verifiëren waar Apple Pay-knoppen worden gebruikt. Landbeperkingen zijn van toepassing.

## v2.13.3

_Januari 14, 2026_

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6399 --> Vaste een kwestie waar de verkeerde in kaart gebrachte kaart tijdens een controle Admin werd gebruikt. De geselecteerde kaart wordt nu correct gebruikt wanneer u een bestelling plaatst.

## v2.13.2

_5 Januari, 2026_

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6390 --> Algemene verbeteringen en optimalisaties door verbeterde JS minificatie uit te voeren.

## v2.13.1

_December 18, 2025_

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6355 --> een kwestie waar de handelaren geen het verschepen methode tijdens controle konden selecteren.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6347 --> Verbeterde controleveerkracht door onnodige API vraag te verwijderen.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6368 --> Geïmplementeerd een fallback mechanisme voor het laden van de Betalingen SDK wanneer het primaire domein niet beschikbaar is, die de gebieden van de creditcard verzekeren toegankelijk blijven tijdens controle.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- PAY-xxxx --> nu, [!DNL Payment Services] steunt PayPal **Eenmalige Controle (OTC)** modaal, die ingebouwde contact en leveringsinformatie bevat.

![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- PAY-xxxx --> Verbeterde mobiele ervaring door **app-schakelaar PayPal authentificatie**, samen met betere API integratie voor soepele gebruikersreizen. Deze functie is alleen beschikbaar voor klanten in de VS [!DNL Payment Services] .

![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- PAY-xxxx --> Toegevoegde **3D Veilige (3DS) authentificatie** steun voor Fastlane om **Sterke Authentificatie van de Klant (SCA)** te ontmoeten. Dit laat VK, en EU [!DNL Payment Services] verkopers toe om transacties met **3DS authentificatie** te verwerken, die fraudepreventie en naleving van regionale verordeningen verbeteren.

![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- PAY-xxxx --> &lbrace;nu, [!DNL Payment Services] handelaren kunnen tussen **licht, en donkere thema&#39;s** voor de Fastlane controlecomponent kiezen, toestaand controlepagina&#39;s om hun plaatsontwerp aan te passen. Als aangepaste stijlen niet aan toegankelijkheidsnormen voldoen, worden de standaardinstellingen automatisch hersteld.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-xxxx --> Vaste loader kwestie tijdens **admin controle met 3DS uitdaging**.

![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-xxxx --> Verbeterde **bevestiging wanneer het opslaan van betalingsconfiguratie** via API.
...
![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- PAY-6164 --> nu, [!DNL Payment Services] gebruikt basismunt voor de beschikbare het verschepen methodes in de [&#x200B; server-kant van PayPal verzendende callback (SSSC) &#x200B;](https://developer.paypal.com/docs/multiparty/checkout/standard/customize/shipping-module/).
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- PAY-6227 --> wanneer het controleren met PayPal, [!DNL Payment Services] slaat pop-up van de ordesbevestiging voor een sneller aankoopproces over. Dit wordt toegelaten door de [&#x200B; server-kant verscheepende callback &#x200B;](payments-options.md#server-side-shipping-callbacks-for-paypal-payment-buttons), die het verschepen en totalen direct binnen de PayPal overzichtspagina berekent.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- PAY-5938 --> nu, [!DNL Payment Services] staat verkopers toe om betalingsmontages te beheren om flexibiliteit in hun zaken te maximaliseren. Deze versie verbetert de capaciteit om [&#x200B; veelvoudige rekeningen PayPal &#x200B;](configure-admin.md#use-multiple-paypal-accounts) voor de gebieden en de merken vast te maken een handelaars steunt. Ons verkoopteam kan een koppeling aan boord bieden om uw website in te stellen en weergavebereiken op te slaan.
...
![&#x200B; Nieuw &#x200B;](../assets/fix.svg)<!-- PAY-5789 --> [!DNL Payment Services] steunt nu [&#x200B; 3D Veilige authentificatie met Google Betalen &#x200B;](security.md#3ds), die veiligheid voor handelaren en klanten tijdens betalingstransacties verbeteren.

![&#x200B; Repareren &#x200B;](../assets/fix.svg)<!-- PAY-5703 --> [!DNL Payment Services] voegt de capaciteit voor [&#x200B; klanten toe om kaarten direct in hun **Mijn Rekening**](vaulting.md#vaulting-without-purchase) te bewaren, die gemak verbetert en toekomstige controles vereenvoudigt. `Vault without purchase functionality might not be 100% compatible with Adobe Commerce 2.4.4 due to a known issue with` [`GraphQL authorization mechanisms` &#x200B;](https://developer.adobe.com/commerce/webapi/graphql/usage/authorization-tokens/) .
...
![&#x200B; Repareren &#x200B;](../assets/fix.svg)<!-- PAY-5792 --> [!DNL Payment Services] toont nu beschrijvingen en het facturerings adressen voor [&#x200B; gefactureerde kaarten op de controlepagina &#x200B;](vaulting.md), die klanten meer zicht in hun bewaarde betalingsmethodes geven.
...
![&#x200B; beval &#x200B;](../assets/fix.svg)<!-- PAY-5492 --> een kwestie vast wanneer een handelaar aangepaste termijnen en voorwaarden aan de controlepagina toevoegt. Tijdens een [&#x200B; uitdrukkelijke controle &#x200B;](payments-options.md#standard-vs-advanced-payments-experience) heeft een verkoopster nu de capaciteit om deze termijnen en voorwaarden goed te keuren om de controle zonder enige kwesties te voltooien.
...
![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- PAY-4868 --> Merchants kunnen [&#x200B; met succes betalen Google door de aankoopervaring &#x200B;](payments-options.md) vormen, gelijkend op andere betalingsknopen in [!DNL Payment Services] door Admin.
...
![&#x200B; verbeter &#x200B;](../assets/fix.svg)<!-- PAY-5291 --> Ontvangend betalingsbevestiging voor sommige transacties kan worden vertraagd. In dat geval kunnen verkopers nu een bijgewerkte betalingsstatus voor een bestelling krijgen. [&#x200B; de diensten van de Betaling ontdekt de hangende status van een betalingstransactie &#x200B;](order-payment-status.md#payment-status-updates) in een orde door hangende transacties te ontdekken en deze transacties proactief te controleren en bij te werken wanneer de hangende status is gevangen.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- PAY-4638 --> voegde een [&#x200B; integratie met het Ondertekenen &#x200B;](fraud-protection.md) toe, die de geautomatiseerde diensten van de fraudebescherming verleent.

![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- PAY-3981 --> [&#x200B; Bevorderde Apple Betalen aan een afzonderlijke betalingsoptie &#x200B;](payments-options.md#apple-pay-button), buiten de PayPal betaalknopen, om winkelzichtbaarheid van de betalingsoptie te verhogen en handelaars toe te staan om de plaatsing en het stileren van het Betaal van Apple te controleren.
...
![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- PAY-4002 --> Toegevoegde functionaliteit om handelaren toe te staan om de orde van hun betalingsopties [&#x200B; te sorteren om bepaalde betalingsopties voorrang te geven. &#x200B;](configure-admin.md#paypal-payment-buttons) Deze functionaliteit moedigt een hoger tarief van het controlegesprek aan.

![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- PAY-4035 --> Merchants kunnen nu efficiënt de gezondheid van hun opslag controleren en om het even welke transactiekwesties identificeren gebruikend het nieuwe [&#x200B; rapport van Transacties &#x200B;](reporting.md#transactions-report-view) beschikbaar bij de [!DNL Payment Services] Admin homepage. In het verslag worden ook gegevens gepresenteerd over de percentages van de transactievergunning en de negatieve tendensen in de transacties.
...
![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- Issue xxx --> toegevoegde [&#x200B; beschikbaarheid in de volgende landen en bijbehorende valuta &#x200B;](compatibility.md#standard-vs-advanced-payment-services-experience): Australië, Frankrijk, Verenigd Koninkrijk.

![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- Issue PAY-4296 --> Toegevoegde [&#x200B; uitgebreide middelen voor rollen Admin &#x200B;](configure-admin.md#configure-roles) om Admin gebruikers te verzekeren kunnen orden voor klanten tot stand brengen en beheren en kunnen [!DNL Payment Services] in het menu van de Verkoop zien.

![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-4236 --> Toegevoegde [&#x200B; auto-voiding voor orden die fouten tijdens controle &#x200B;](checkout.md#order-auto-voided-if-error) veroorzaken.

![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- Issue PAY-4183 --> Gemaakt functionaliteit aan [&#x200B; toont de knoop van de de optietoewijzing van de creditcard/debetkaart &#x200B;](payments-options.md#paypal-debit-or-credit-card-button) op de controlepagina.
...
![&#x200B; bevestig &#x200B;](../assets/fix.svg)<!-- Issue PAY-4205 --> een kwestie die de gespecificeerde het verschepen adresstaat veroorzaakte om door de staat in de standaard belastingmontages tijdens controle worden vervangen gebruikend de [&#x200B; optie PayPal &#x200B;](payments-options.md#paypal-payment-buttons). Nu kunnen klanten hun bestellingen naar een andere staat laten verzenden dan die welke in de belastinginstellingen van de handelaar als standaard is geconfigureerd.

![&#x200B; beval &#x200B;](../assets/fix.svg)<!-- Issue PAY-4202 --> een kwestie Vast die klanten verhindert kaartvaulting te gebruiken om een aankoop te voltooien of een in gebreke gebleven betalingsmethode voor een opslag te schrappen [&#x200B; gebruikend de `Authorize and Capture` betalingsactie &#x200B;](production.md#set-payment-services-as-payment-method). Eerder werd een fout met betrekking tot de &quot;Provider Vault ID not found&quot; weergegeven toen de klant probeerde de gefactureerde creditcards te gebruiken of te wijzigen.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-784 -->[!DNL Payment Services] omvat nu de capaciteit aan opstelling een handelaarrekening aan [&#x200B; gebruiks veelvoudige PayPal bedrijfsrekeningen &#x200B;](configure-admin.md#use-multiple-paypal-accounts). Hierdoor kan de handelaar in meerdere landen uw winkels bedienen met verschillende valuta&#39;s, of Adobe Commerce gebruiken voor een deel van uw bedrijf.

![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- Issue PAY-3231 --> Merchants kunnen [&#x200B; a [!UICONTROL Soft Descriptor]](configure-admin.md) aan websites of de individuele configuratie van de opslagmeningen toevoegen die op de verklaringen van de de bank van de klantentransactie tonen om merken, opslag, of productlijnen te afbakenen.

![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-3707 --> [&#x200B; laat of maak creditcardgebieden en PayPal betaalknopen &#x200B;](configure-admin.md#paypal-payment-buttons) voor controle in [!DNL Payment Services] montages toe onbruikbaar.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-2682 --> De [!DNL Payment Services] uitbreiding voor [!DNL Adobe Commerce] en [!DNL Magento Open Source] is nu beschikbaar voor Canadese handelaren. De handelaren kunnen betalingsconfiguratie in of [&#x200B; Frans &#x200B;](compatibility.md##standard-vs-advanced-payment-services-experience) of [&#x200B; Engels &#x200B;](compatibility.md#standard-vs-advanced-payment-services-experience) bekijken.

![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-2681 --> [!DNL Payment Services] steunt [&#x200B; Canadese dollars (CAD) &#x200B;](compatibility.md#standard-vs-advanced-payment-services-experience) voor creditcards en transacties PayPal.
...
![&#x200B; Vaste kwestie &#x200B;](../assets/fix.svg)<!-- Issue PAY-2277 --> U kunt nu selectief [&#x200B; toelaten of individuele PayPal betalingsknopen onbruikbaar maken &#x200B;](configure-admin.md#paypal-payment-buttons).
