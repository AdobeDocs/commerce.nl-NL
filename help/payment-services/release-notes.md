...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-4050 --> Toegevoegde a [&#x200B; mening van de gegevensvisualisatie &#x200B;](/help/payment-services/payouts.md#payouts-data-visualization-view), die op het Huis van de Dienst van de Betaling, voor het rapport van de de betalingsstatus van de Orde verschijnt.
...
![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- Issue PAY-1720 --> Geschillen voor opslagorden zijn nu beschikbaar in [&#x200B; het rapport van de de betalingsstatus van de Orde &#x200B;](/help/payment-services/order-payment-status.md#view-disputes). U kunt geschillen oplossen door rechtstreeks vanuit [!DNL Payment Services] naar het PayPal Resolution Center te navigeren.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- Issue PAY-2761 --> U kunt de gegevens nu aanpassen die in het [&#x200B; rapport van de de betalingsstatus van de Orde &#x200B;](/help/payment-services/order-payment-status.md#show-and-hide-columns) en het [&#x200B; rapport van Uitbetalingen &#x200B;](/help/payment-services/payouts.md#show-and-hide-columns) door kolommen te tonen of te verbergen gebruikend de de montagecontrole van de Kolom tonen.
...
![&#x200B; Nieuw &#x200B;](../assets/new.svg)<!-- PAY-6227 --> wanneer het controleren met PayPal, [!DNL Payment Services] slaat pop-up van de ordesbevestiging voor een sneller aankoopproces over. Dit wordt toegelaten door de [&#x200B; server-kant verscheepende callback &#x200B;](payments-options.md#server-side-shipping-callback), die het verschepen en totalen direct binnen de PayPal overzichtspagina berekent.
...
![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- PAY-4868 --> Merchants kunnen [&#x200B; met succes betalen Google door de aankoopervaring &#x200B;](/help/payment-services/payments-options.md) vormen, gelijkend op andere betalingsknopen in [!DNL Payment Services] door Admin.
...
![&#x200B; verbeter &#x200B;](../assets/fix.svg)<!-- PAY-5291 --> Ontvangend betalingsbevestiging voor sommige transacties kan worden vertraagd. In dat geval kunnen verkopers nu een bijgewerkte betalingsstatus voor een bestelling krijgen. [&#x200B; de diensten van de Betaling ontdekt de hangende status van een betalingstransactie &#x200B;](/help/payment-services/order-payment-status.md#payment-status-updates) in een orde door hangende transacties te ontdekken en deze transacties proactief te controleren en bij te werken wanneer de hangende status is gevangen.
...
![&#x200B; Nieuwe &#x200B;](../assets/new.svg)<!-- Issue xxx --> toegevoegde [&#x200B; beschikbaarheid in de volgende landen en bijbehorende valuta &#x200B;](introduction.md#availability): Australië, Frankrijk, Verenigd Koninkrijk.
