...
[!DNL Product Recommendations] de gebruikers kunnen naar het [&#x200B; dashboard van het Beheer van Gegevens &#x200B;](https://experienceleague.adobe.com/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard.html) voor meer gegevens over gegevens verwijzen synchroniseren.
...
Om de catalogusgegevens in uw milieu opnieuw te activeren, [&#x200B; voorlegt een steunverzoek &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#experience-league-start-page) met de titel: &quot;Reactivate [!DNL Product Recommendations]&quot;en omvat milieu IDs. De catalogusgegevens in uw omgeving moeten binnen een paar uur worden hersteld.
