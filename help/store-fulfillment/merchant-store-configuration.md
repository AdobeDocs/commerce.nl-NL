...
| **[!UICONTROL Enable Ship to Store]**</br>`Extension Attribute: [!DNL allow_ship_to_store]` | Vorm schip-aan-opslagmogelijkheden op het bronniveau. Voor meer informatie, zie de [&#128279;](enable-general.md) optie van de Configuratie 0&rbrace; Algemene **[!UICONTROL Enable Ship To Store]**. | Algemeen | Nee |
| **[!UICONTROL Enable Ship From Store]**</br>`Extension Attribute: [!DNL use_as_shipping_source]` | Vorm schip-van-opslag mogelijkheden op het bronniveau. Voor meer informatie, zie de [&#128279;](enable-general.md) optie van de Configuratie 0&rbrace; Algemene [!UICONTROL Enable Ship From Store] | Algemeen | Nee |
